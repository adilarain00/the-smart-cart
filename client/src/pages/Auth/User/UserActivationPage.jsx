...
const UserActivationPage = () => {
  ...
  return (
    <div className='min-h-screen flex flex-col justify-center py-12 sm:px-6 lg:px-8'>
      ...
      >
        <motion.div
          className='bg-white py-10 px-8 shadow-[0_0_20px_rgba(0,0,0,0.05)] rounded-lg flex flex-col items-center border border-gray-200'
        ...
        >
          ...
          {!error && (
            <motion.a
              href='/user/login'
              className='mt-4 inline-block px-6 py-2 bg-gradient-to-r from-blue-500 to-purple-600 text-white rounded-lg font-semibold shadow hover:from-blue-600 hover:to-purple-700 hover:text-gray-100 transition-all duration-300'
              initial={{ opacity: 0, y: 10 }}
              animate={{ opacity: 1, y: 0 }}
