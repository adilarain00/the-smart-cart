...
const SuggestedProduct = ({ data }) => {
  ...
  return (
    <div>
      {data ? (
        <div className='p-6 bg-white rounded-lg shadow-[0_0_20px_rgba(0,0,0,0.05)] border border-gray-100 w-11/12 mx-auto mt-8 mb-10'>
          <h2 className='text-[25px] font-[600] text-blue-500 border-b-2 border-gray-100 pb-2 mb-6'>
            Related Products
          </h2>
