...
const AdminDashboardWithdraw = () => {
  ...
  return loading ? (
    ...
    <div className='w-full'>
      <div className='block md:hidden space-y-4'>
        ...
        {totalPages > 1 && (
          <div className='flex justify-center items-center gap-2 mt-4'>
            <button
              className='px-2 py-1 rounded bg-gray-100 text-gray-700 hover:bg-gray-300 disabled:opacity-50'
      ...
      <div className='hidden md:block shadow-[0_0_20px_rgba(0,0,0,0.05)] rounded-lg'>
        ...
        <div className='fixed w-full h-screen bg-[#0000004b] top-0 left-0 flex items-center justify-center z-50'>
          <div className='w-full max-w-[35rem] bg-white py-8 px-4 shadow-[0_0_20px_rgba(0,0,0,0.05)] sm:rounded-lg sm:px-10 relative overflow-y-scroll max-h-[90vh]'>
            ...
            <div className='flex flex-col items-center gap-4 mt-2'>
              ...
              <button
                type='button'
                className='px-6 py-2 rounded bg-gradient-to-r from-blue-500 to-purple-600 text-white font-medium hover:from-blue-600 hover:to-purple-700 hover:text-gray-100 transition text-lg'
