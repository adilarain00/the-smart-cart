  ...
  return adminOrderLoading || adminSellersLoading ? (
    ...
    <div className='w-full'>
      ...
      <div className='grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6 mt-4 w-full'>
        <div className='shadow-[0_0_20px_rgba(0,0,0,0.05)] rounded-lg p-4 sm:p-5 space-y-4'>
        ...
        <div className='shadow-[0_0_20px_rgba(0,0,0,0.05)] rounded-lg p-4 sm:p-5 space-y-4'>
          ...
          <Link to='/admin/dashboard-sellers'>
            <p className='text-blue-500 hover:text-gray-800 font-medium text-xs sm:text-sm pl-1'>
              View Sellers
            </p>
          </Link>
        </div>
      ...
      <div className='hidden md:block w-full min-h-[45vh] rounded-lg overflow-x-auto shadow-[0_0_20px_rgba(0,0,0,0.05)]'>
        ...
        {adminOrders && adminOrders.length > pageSize && (
          <div className='flex justify-center items-center gap-1 my-4'>
            <button
              className='px-2 py-1 rounded-lg bg-gray-50 text-gray-700 border border-gray-300 hover:bg-gray-100 transition disabled:opacity-50 text-xs'
              onClick={() => setPage((prev) => Math.max(prev - 1, 1))}
              disabled={page === 1}
            >
              &lt;
