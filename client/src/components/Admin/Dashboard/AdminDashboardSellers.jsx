...
const AdminDashboardSellers = () => {
  ...
  return adminSellersLoading ? (
    ...
    <div className='w-full'>
              ...
              <div className='space-y-3'>
                ...
                <div className='flex justify-end gap-2'>
                  <Link to={`/seller/profile/preview/${user._id}`}>
                    <button
                      className='bg-gradient-to-r from-blue-500 to-purple-600 text-white hover:from-blue-600 hover:to-purple-700 hover:text-gray-100 rounded-lg p-1 transition'
                      title='View Seller'
                    >
                  ...
                  <button
                    className='bg-red-500 text-white hover:from-blue-600 hover:to-purple-700 hover:text-gray-100 rounded-lg p-1 transition'
                    onClick={() => {
      ...
      <div className='hidden md:block w-full rounded-lg overflow-x-auto shadow-[0_0_20px_rgba(0,0,0,0.05)]'>
        ...
        {adminSellers && adminSellers.length > pageSize && (
          <div className='flex justify-center items-center gap-1 my-4'>
            <button
              className='px-2 py-1 rounded-lg border text-xs bg-gray-50 text-gray-700 hover:bg-gray-100 mx-0.5 transition disabled:opacity-50'
              onClick={() => setPage((prev) => Math.max(prev - 1, 1))}
              disabled={page === 1}
            >
              &lt;
            ...
            {Array.from({ length: totalPages }, (_, i) => (
              <button
                key={i + 1}
                className={`px-2 py-1 rounded-lg border text-xs mx-0.5 ${
                  page === i + 1
                    ? 'bg-gradient-to-r from-blue-500 to-purple-600 text-white hover:from-blue-600 hover:to-purple-700 hover:text-gray-100'
      ...
      {open && (
        <div className='fixed inset-0 z-[999] bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 hover:text-gray-100 bg-opacity-40 flex items-center justify-center'>
          <div className='w-[95%] md:w-[400px] bg-white rounded shadow-lg p-6 animate-fadeIn'>
            ...
            <div className='flex justify-center gap-4 mt-6'>
              <button
                className='px-6 py-2 rounded bg-gray-100 text-gray-700 font-medium hover:bg-gray-300 transition'
                onClick={() => setOpen(false)}
              >
                Cancel
              </button>
