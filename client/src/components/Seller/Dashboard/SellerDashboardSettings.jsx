      ...
      <div className='w-full flex flex-col items-center'>
        <div className='w-full max-w-2xl bg-white py-6 md:py-8 px-4 md:px-6 lg:px-10 shadow-[0_0_20px_rgba(0,0,0,0.05)] rounded-lg'>
          <form onSubmit={updateHandler} className='space-y-4 md:space-y-6'>
            ...
            <button
              type='submit'
              className='w-full py-2 md:py-3 bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 hover:text-gray-100 text-white cursor-pointer rounded-lg font-semibold tracking-wide transition mt-4 flex items-center justify-center'
            >
              Update
            </button>
          </form>
