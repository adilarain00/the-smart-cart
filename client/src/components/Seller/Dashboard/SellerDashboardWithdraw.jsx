...
const SellerDashboardWithdraw = () => {
  ...
  return (
    <div className='w-full h-full flex justify-center items-start'>
      <div className='max-w-md w-full rounded-lg shadow-[0_0_20px_rgba(0,0,0,0.05)] p-6 space-y-4'>
        ...
        <button
          ...
          className='w-full py-2 bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 hover:text-gray-100 text-white rounded-lg font-medium transition'
        >
          Withdraw Funds
        </button>
      </div>
      ...
      {open && (
        <div className='fixed inset-0 bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 hover:text-gray-100/50 flex justify-center items-center z-50'>
          <div className='bg-white rounded-lg shadow-lg w-full max-w-lg p-6 max-h-[90vh] overflow-y-auto'>
            ...
            {adding ? (
              <form onSubmit={handleAddMethod} className='space-y-4'>
                ...
                <button
                  type='submit'
                  className='w-full py-2 bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 hover:text-gray-100 text-white rounded-lg flex items-center justify-center'
                >
                  Add Method
                </button>
              </form>
              ...
              <div className='space-y-4'>
                <div className='flex justify-between items-center'>
                  ...
                  <button
                    className='flex items-center justify-center bg-red-500 hover:from-blue-600 hover:to-purple-700 hover:text-gray-100 rounded-lg p-2 transition-colors duration-200'
                ...
                <div className='mt-4'>
                  ...
                  <button
                    ...
                    className='w-full mt-2 py-2  bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 hover:text-gray-100 text-white rounded-lg flex items-center justify-center'
                  >
                    Withdraw
                  </button>
                </div>
              ...
              <div className='text-center space-y-4'>
                ...
                <button
                  ...
                  className='flex items-center justify-center gap-1 text-blue-500 hover:text-gray-800 font-medium'
                >
