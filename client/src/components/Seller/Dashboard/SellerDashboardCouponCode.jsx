    ...
    <>
      {isLoading ? (
        ...
        <div className='w-full space-y-6'>
          <button
            className='text-white bg-gradient-to-r from-blue-500 to-purple-600 hover:text-white font-semibold px-5 py-2 rounded-lg transition-shadow duration-300 focus:outline-none'
                ...
                >
                  <div className='space-y-3'>
                    ...
                    <div className='flex justify-end'>
                      <button
                        className='bg-red-500 hover:from-blue-600 hover:to-purple-700 hover:text-gray-100 text-white rounded-lg p-2 shadow-md transition-shadow duration-300 focus:outline-none'
                        title='Delete'
                  ...
                  coupons.map((item) => (
                    ...
                    >
                      ...
                      <td className='px-4 lg:px-6 py-3'>
                        <button
                          className='bg-red-500 hover:from-blue-600 hover:to-purple-700 hover:text-gray-100 text-white rounded-lg p-2 transition-shadow duration-300 focus:outline-none'
                          title='Delete'
                          onClick={() => handleDelete(item._id)}
                        >
            ...
            <div className='fixed w-full h-screen bg-[#0000004b] top-0 left-0 flex items-center justify-center z-50'>
              <div className='w-full max-w-[35rem] bg-white py-8 px-4 shadow-lg sm:rounded-lg sm:px-10 relative overflow-y-scroll max-h-[90vh]'>
                ...
                <form onSubmit={handleSubmit} className='space-y-4'>
                  ...
                  <button
                    type='submit'
                    className='w-full py-2 bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 hover:text-gray-100 text-white rounded-lg font-semibold duration-300 focus:outline-none focus:ring-2 focus:ring-gray-400 flex items-center justify-center'
                  >
                    Create
                  </button>
                </form>
