      ...
      <div className='bg-white rounded-lg shadow-md p-6 md:p-10 space-y-6'>
        <div className='flex flex-col md:flex-row items-center justify-between text-blue-500'>
          ...
          <Link to='/seller/dashboard-orders'>
            <div className='bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 hover:text-gray-100 mt-5 sm:mt-0 text-white font-medium py-2 px-6 rounded-lg transition'>
              Order List
            </div>
          </Link>
        </div>
          ...
          <div className='flex flex-col md:flex-row md:items-center gap-4'>
            ...
            data?.status !== 'Refund Success' ? (
              <select
                ...
                className='w-full md:w-[300px] px-4 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 text-lg'
              >
                {[
                  'Processing',
            ...
            <button
              className='w-full md:w-auto bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 hover:text-gray-100 text-white rounded-lg font-semibold h-11 text-lg px-8 transition shadow-sm'
              onClick={
                data?.status !== 'Processing refund'
                  ? orderUpdateHandler
