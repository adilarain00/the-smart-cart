...
const SellerDashboardMessages = () => {
  ...
  return (
    <div className='w-full max-w-4xl mx-auto bg-white rounded-lg shadow-[0_0_20px_rgba(0,0,0,0.05)] h-[85vh] flex overflow-hidden'>
      <div
...
const MessageList = ({
  ...
  return (
    <div
      className={`flex items-center gap-3 px-4 py-3 cursor-pointer hover:bg-blue-50 transition group ${
    ...
    <div className='flex flex-col h-full'>
          ...
          messages.map((item, index) => (
            ...
            >
              ...
              {item.image && (
                <img
                  src={item.image?.url}
                  className='w-[300px] h-[300px] object-cover rounded-lg border border-gray-300 mr-2'
                  alt='chat-img'
                  onError={(e) => {
                    e.target.onerror = null;
              ...
              {item.text && (
                <div>
                  <div
                    className={`max-w-xs md:max-w-md p-3 rounded-lg shadow text-base break-words ${
                      item.sender === sellerId
                        ? 'bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 hover:text-gray-100 text-white'
      ...
      >
        ...
        <div className='flex-1 relative'>
          ...
          <button
            type='submit'
            className='absolute right-2 top-1/2 -translate-y-1/2 bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 hover:text-gray-100 text-white rounded-lg p-2 transition'
          >
