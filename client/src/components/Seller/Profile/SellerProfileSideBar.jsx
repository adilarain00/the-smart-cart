...
const SellerProfileSideBar = ({ isOwner, sellerData }) => {
  ...
  return (
    <div className='w-full bg-white shadow-[0_0_20px_rgba(0,0,0,0.05)] rounded-lg p-6 border border-gray-100'>
      ...
      {isOwner && (
        <div className='flex flex-col gap-3 mt-6'>
          <Link to='/seller/dashboard-settings'>
            <button className='w-full h-11 rounded-lg bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 hover:text-gray-100 text-white font-semibold transition'>
              Edit Seller Info
            </button>
          </Link>
          <button
            className='w-full h-11 rounded-lg bg-gray-200 hover:bg-gray-300 text-gray-700 font-semibold transition'
