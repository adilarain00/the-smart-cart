      ...
      <div className='flex flex-col sm:flex-row w-full items-start sm:items-center justify-between gap-4 sm:gap-0 border-b border-gray-100 pb-2'>
        ...
        {isOwner && (
          <Link to='/seller/dashboard' className='w-full sm:w-auto'>
            <div className='rounded h-[39.5px] bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 hover:text-gray-100 flex items-center justify-center px-4 w-full sm:w-auto mt-3 sm:mt-0'>
