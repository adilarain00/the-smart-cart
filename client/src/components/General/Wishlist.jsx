          ...
          <>
            <div>
              ...
              <div className='flex items-center gap-2 p-4 border-b border-gray-100'>
                <AiOutlineHeart size={25} className='text-blue-700' />
  ...
  return (
    <div className='flex items-center gap-4 bg-white p-4 mb-4 border border-gray-100 relative'>
      ...
      <div className='flex-1 flex flex-col justify-between'>
        ...
        <span className='text-black font-bold text-md mt-1'>
          US${totalPrice}
        </span>
      </div>
      <div className='flex flex-col items-end justify-between h-full ml-2 gap-2'>
        ...
        <button
          className='text-red-500 hover:text-red-600 transition hover:rotate-180'
          title='Remove'
