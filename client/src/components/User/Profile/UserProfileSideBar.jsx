...
const UserSideBar = ({ setActive, active }) => {
  ...
  return (
    <div className='w-full bg-white shadow-[0_0_20px_rgba(0,0,0,0.05)] rounded-lg'>
      <div className='flex lg:flex-col overflow-x-auto lg:overflow-x-visible p-3 lg:p-4 lg:pt-8 gap-2 lg:gap-0'>
        {sidebarItems.map((item) => {
          ...
          return (
            <div
              key={item.key}
              className={`flex items-center gap-3 cursor-pointer mb-0 lg:mb-4 px-3 py-2 rounded-lg transition whitespace-nowrap lg:whitespace-normal min-w-max lg:min-w-0 flex-shrink-0 lg:flex-shrink
        ...
        <div
          className={`flex items-center gap-3 cursor-pointer px-3 py-2 rounded-lg transition whitespace-nowrap lg:whitespace-normal min-w-max lg:min-w-0 flex-shrink-0 lg:flex-shrink
