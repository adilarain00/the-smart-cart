        ...
        <>
          <div className='flex justify-center w-full mb-8'>
            <div className='relative'>
              <img
                src={`${user?.avatar?.url}`}
                className='w-32 h-32 md:w-40 md:h-40 lg:w-[150px] lg:h-[150px] rounded-full object-cover border-4 border-blue-600 shadow-[0_0_20px_rgba(0,0,0,0.05)]'
                alt='User Profile'
                onError={(e) => {
          ...
          <div className='w-full flex flex-col items-center'>
            <div className='w-full max-w-2xl bg-white py-6 md:py-8 px-4 md:px-6 lg:px-10 shadow-[0_0_20px_rgba(0,0,0,0.05)] rounded-lg'>
              <form
              ...
              >
                ...
                <input
                  className='w-full py-2 md:py-3 bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 hover:text-gray-100 text-white cursor-pointer rounded-lg font-semibold tracking-wide transition mt-4'
                  required
                  value='Update'
                  type='submit'
                />
              ...
              <div className='space-y-3'>
                <div className='flex justify-between items-start'>
                  ...
                  <Link to={`/user/order/${order._id}`}>
                    <button className='bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 hover:text-gray-100 text-white rounded-lg p-2 transition'>
              ...
              orders.map((order) => (
                ...
                >
                  ...
                  <td className='px-4 lg:px-6 py-3'>
                    <Link to={`/user/order/${order._id}`}>
                      <button className='bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 hover:text-gray-100 text-white rounded-lg p-2 transition-colors duration-200'>
...
const ChangePassword = () => {
  ...
  return (
    <div className='w-full flex flex-col items-center'>
      <div className='w-full max-w-[35rem] bg-white py-8 px-4 shadow-[0_0_20px_rgba(0,0,0,0.05)] sm:rounded-lg sm:px-10 mt-8'>
        ...
        <form onSubmit={passwordChangeHandler} className='space-y-6'>
          ...
          <button
            className='w-full py-2 bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 hover:text-gray-100 hover:bg-gray-600 text-white rounded-lg font-semibold tracking-wide transition mt-4'
            type='submit'
          >
            Update
          </button>
    ...
    <div className='w-full px-5'>
      {open && (
        <div className='fixed w-full h-screen bg-[#0000004b] top-0 left-0 flex items-center justify-center z-50'>
          <div className='w-full max-w-[35rem] bg-white py-8 px-4 shadow-[0_0_20px_rgba(0,0,0,0.05)] sm:rounded-lg sm:px-10 relative overflow-y-scroll max-h-[90vh]'>
              ...
              <form aria-required onSubmit={handleSubmit} className='w-full'>
                <div className='w-full block p-4'>
                  ...
                  <div className='w-full pb-2'>
                    <input
                      type='submit'
                      className='w-full py-2 bg-gradient-to-r from-blue-500 to-purple-600   hover:from-blue-600 hover:to-purple-700 hover:text-gray-100 text-white rounded-lg font-semibold tracking-wide transition mt-4 cursor-pointer'
                      required
                      readOnly
                    />
                  </div>
      ...
      <div className='flex flex-col sm:flex-row w-full items-start sm:items-center justify-between gap-3 sm:gap-0 mb-5'>
        ...
        <div
          className='bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 hover:text-gray-100 text-white font-semibold w-full sm:w-auto text-center p-2 sm:px-4 sm:py-2 rounded-lg transition cursor-pointer'
      ...
      {user &&
        user.addresses.map((item, index) => (
          <div
            className='w-full bg-white min-h-[70px] rounded-lg flex flex-col md:flex-row items-start md:items-center px-3 shadow-[0_0_20px_rgba(0,0,0,0.05)] justify-between md:pr-10 mb-5 border border-gray-100 gap-2 md:gap-0'
            key={index}
          >
