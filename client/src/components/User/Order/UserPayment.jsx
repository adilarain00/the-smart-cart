      ...
      <div className='mt-8'>
            ...
            <div className='flex gap-4'>
              <div className='flex-1'>
                ...
                <input
                  ...
                  className='w-full h-11 px-4 text-[16px] border border-gray-300 rounded-lg shadow-sm placeholder:text-gray-500 placeholder:font-normal  focus:outline-none focus:ring-blue-500 focus:border-blue-500'
                />
              </div>
              ...
              <div className='flex-1'>
                ...
                <div className='w-full h-11 flex items-center'>
                  <CardExpiryElement
                    className='w-full h-full px-4 py-3 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 bg-white'
                    options={{
                      style: {
                        base: {
                          fontSize: '16px',
        ...
        {select === 2 && (
          <div className='w-full flex flex-col gap-4'>
            ...
            {open && (
              <div className='fixed top-0 left-0 w-full h-full bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 hover:text-gray-100 bg-opacity-40 flex items-center justify-center z-50'>
...
const CartData = ({ orderData }) => {
  ...
  return (
    <div className='bg-white rounded-lg shadow-[0_0_20px_rgba(0,0,0,0.05)] pb-2 pt-8 pl-8 pr-8'>
