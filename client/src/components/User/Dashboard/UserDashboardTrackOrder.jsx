...
const statusMessages = {
  Processing: 'Your order is being prepared at the shop.',
  'Transferred to delivery partner':
    'Your order has been handed to the delivery partner.',
  Shipping: 'Your order is with the delivery partner and on its way.',
  Received: 'Your order has reached your city and will arrive soon.',
  'On the way': 'Your order is out for delivery. Get ready to receive it!',
          ...
          <div className='bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden'>
            ...
            <div className='p-6 sm:p-8'>
              <div className='relative'>
                <div className='absolute top-6 left-0 w-full h-0.5 bg-gray-200 hover:bg-gray-300 hidden sm:block' />
                <div
            ...
            <div
              className={`mx-6 mb-6 p-4 rounded-lg border ${getStatusBgColor(
                order.status
              )}`}
            >
              <div className='flex items-start gap-3'>
                <div
                  className={`flex-shrink-0 w-6 h-6 rounded-lg flex items-center justify-center ${getStatusColor(
                    order.status
                  )} mt-0.5`}
                >
