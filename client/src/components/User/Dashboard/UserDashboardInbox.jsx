...
const UserDashboardInbox = () => {
  ...
  return (
    <div className='w-full max-w-4xl mx-auto bg-white rounded-lg shadow-[0_0_20px_rgba(0,0,0,0.05)] mt-8 h-[85vh] flex overflow-hidden'>
      <div
          ...
          messages.map((item, index) => (
            ...
            >
              ...
              {item.image && (
                <img
                  src={item.image?.url}
                  className='w-[200px] h-[200px] sm:w-[300px] sm:h-[300px] object-cover rounded-lg border border-gray-300 mr-2'
                  alt='chat-img'
                  onError={(e) => {
                    e.target.onerror = null;
