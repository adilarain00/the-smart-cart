  ...
  return isLoading ? (
    ...
    <div className='w-11/12 mx-auto flex flex-col py-10 min-h-screen px-4 md:px-8'>
      <div className='bg-white rounded-lg shadow-md p-6 md:p-10 space-y-6'>
        <div className='flex flex-col md:flex-row items-center justify-between text-blue-500'>
            ...
            >
              ...
              <div className='flex-1 flex flex-col md:flex-row md:items-center md:justify-between gap-2'>
                ...
                {!item.isReviewed && data?.status === 'Delivered' ? (
                  <button
                    className='mt-2 md:mt-0 ml-0 md:ml-4 bg-gray-100 text-gray-600 font-semibold rounded-lg px-5 py-2 text-base transition border border-gray-200 shadow-sm'
        ...
        {open && (
          <div className='fixed w-full h-screen bg-[#0000004b] top-0 left-0 flex items-center justify-center z-50'>
            <div className='w-full max-w-[35rem] bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10 relative overflow-y-scroll max-h-[90vh]'>
              ...
              <button
                className={`w-full py-3 bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 hover:text-gray-100 text-white rounded-lg font-semibold text-lg transition`}
        ...
        <div className='text-right pt-4 mt-4 border-t'>
          <h5 className='text-lg md:text-xl font-semibold text-gray-800'>
            Total Price:{' '}
            <span className='text-blue-600'>US${data?.totalPrice}</span>
          </h5>
        </div>
        ...
        <div className='flex flex-col md:flex-row gap-4 mt-6'>
          {data?.status === 'Delivered' && (
            <button
              ...
              className='w-full md:w-auto bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 hover:text-gray-100 text-white rounded-lg font-semibold h-11 text-lg px-8 transition'
            >
              Give a Refund
            </button>
          )}
          <button
            className='w-full md:w-auto flex items-center justify-center gap-2 bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 hover:bg-gray-300 hover:text-black text-white font-semibold rounded-lg py-3 px-4 shadow-sm transition'
